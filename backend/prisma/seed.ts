...
async function main() {
  ...
  // Episode 1: General Knowledge for Participants
  ...
  // Episode 2: Science & Technology for Participants
  ...
  // Episode 3: History & Geography for Audience
  ...
  // Episode 4: Sports & Entertainment for Audience
